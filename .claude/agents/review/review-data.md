...
`.agents/rules/api.md`. 파일마다 하는 일은 `CONTRIBUTING.md` 데이터 층 절의 표에 있고 백엔드 계약의 정본은 `../geoji-server/API.md`와 그 컨트롤러다. 어느 층에 파일을 두는지는 review-structure, 라우터 이동은 review-router 몫이다.
